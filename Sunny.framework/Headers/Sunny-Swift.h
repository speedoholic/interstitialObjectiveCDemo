...
@interface NSURL (SWIFT_EXTENSION(Sunny))
@property (nonatomic, readonly, copy) NSString * _Nonnull URLString;
@end


@interface NSURLComponents (SWIFT_EXTENSION(Sunny))
@property (nonatomic, readonly, copy) NSString * _Nonnull URLString;
@end
...
@interface SessionDelegate (SWIFT_EXTENSION(Sunny)) <NSURLSessionStreamDelegate>
